(function(l) {
    ...
    function(l, m, n) {
        ...
        var k = n(7),
            ...
            a = n(10);
        n(11);
        new l.a({ settings: window.themehouse.settings.inputSync }).register();
        new m.a({ settings: window.themehouse.settings.loginPanel }).register();
        new k.a({ settings: window.themehouse.settings.sidebar }).register();
        new f.a({ settings: window.themehouse.settings.nodes }).register();
        new b.a({ settings: window.themehouse.settings.tooltipFix }).register();
        new a.a({
    ...
    function(l, m, n) {
            ...
            function f(b) {
                ...
                this.sync = function(e) {
                    ...
                    if (g) {
                        ...
                        g = window.document.querySelectorAll(
                            a.settings.selector +
                                "[data-" +
                                a.settings.data +
                                '="' +
                ...
                this.initGet = function() {
                    a.inputs = window.document.querySelectorAll(
                        a.settings.selector
                    );
        ...
        window.themehouse.inputSync = { inputSync: l };
        m.a = l;
    },
    function(l, m, n) {
        var k = (function() {
            ...
            function f(b) {
                ...
                this.setState = function(e, g) {
                    if (e) {
                        ...
                        window.document
                            .querySelector(a.settings.loginSelector)
                            .classList.remove(a.settings.active),
                            window.document
                                .querySelector(a.settings.registerSelector)
                                .classList.remove(a.settings.active),
                            a.listener &&
                ...
                this.initGet = function() {
                    var e = window.document.querySelector(
                        a.settings.loginTriggerSelector
                    );
                    e &&
                    ...
                    (e = window.document.querySelector(
                        a.settings.registerTriggerSelector
                    )) &&
                        e.addEventListener("click", function(g) {
                            g.preventDefault();
        ...
        "undefined" === typeof window.themehouse && (window.themehouse = {});
        window.themehouse.loginPanel = { loginPanel: l };
        m.a = l;
    },
    function(l, m, n) {
        var k = (function() {
        ...
        l = (function() {
            function f(b) {
                ...
                this.toggleSidebar = function() {
                    var e = "1";
                    window.document
                        .querySelector(a.settings.selector)
                        .classList.contains(a.settings.collapseClass)
                        ? (window.document
                              .querySelector(a.settings.selector)
                              .classList.remove(a.settings.collapseClass),
                          (e = "0"))
                        : window.document
                              .querySelector(a.settings.selector)
                              .classList.add(a.settings.collapseClass);
                    null === a.settings.link
                        ? a.common.warn("No AJAX link set for sidebar toggle")
                        : a.common.fetch({
                              url: a.settings.link,
                              data: { collapsed: e }
                          });
                ...
                this.initGet = function() {
                    var e = window.document.querySelectorAll(
                        a.settings.triggerSelector
                    );
                    if (e && e.length)
        ...
        "undefined" === typeof window.themehouse && (window.themehouse = {});
        window.themehouse.sidebar = { sidebar: l };
        m.a = l;
    },
    function(l, m, n) {
        var k = (function() {
        ...
        "undefined" === typeof window.themehouse && (window.themehouse = {});
        window.themehouse.nodeClick = { nodes: l };
        m.a = l;
    },
    function(l, m, n) {
        var k = (function() {
        ...
        l = (function() {
            function f(b) {
                ...
                this.scrollGet = function() {
                    window.XF.MemberTooltip.activeTooltip &&
                        window.XF.MemberTooltip.activeTooltip.trigger &&
                        window.XF.MemberTooltip.activeTooltip.trigger.$target &&
                        window.XF.MemberTooltip.activeTooltip.trigger.$target
                            .length &&
                        window.XF.MemberTooltip.activeTooltip.trigger.$target[0].closest(
                            a.settings.fixClassSelector
                        ) &&
                        (a.needsReposition = !0);
                };
                ...
                this.settings = Object.assign(
                    { fixClassSelector: ".uix_stickyBodyElement", enabled: !1 },
                    d
                );
                this.commonVersion = b;
                this.common = window.themehouse.common[b];
        ...
        "undefined" === typeof window.themehouse && (window.themehouse = {});
        window.themehouse.tooltipFix = { tooltipFix: l };
        m.a = l;
    },
    function(l, m, n) {
        var k = (function() {
            ...
            function f(b) {
                ...
                this.setState = function(e, g) {
                    if (e) {
                        ...
                        h &&
                            (a.common.values.innerWidth <
                            parseInt(a.settings.breakpoint, 10)
                                ? h.classList.add(a.settings.active)
                                : h.classList.remove(a.settings.active));
                    } else {
                        a.focusBlocked = !0;
                        if (
                            (h = window.document.querySelectorAll(
                                "." + a.settings.active
                            ))
                        )
                            for (var p = 0, t = h.length; p < t; p++)
                                h[p].classList.remove(a.settings.active);
                        a.blurActiveEle();
                        window.setTimeout(function() {
                            a.blurActiveEle();
                            a.focusBlocked = !1;
                ...
                this.setDropdown = function(e, g) {
                    if (g) {
                        var h = e
                            .closest(a.settings.searchBarSelector)
                            .querySelector(a.settings.selector);
                        h &&
                            ((h = h.getBoundingClientRect()),
                            (e.style.top = h.height + 10 + "px"));
                        ...
                        if ((h = e.querySelector("form")))
                            a.recentlyOpenedForm = h;
                    } else
                        e.classList.remove(a.settings.searchDropdownActive),
                            (e.style.top = ""),
                            --a.numOpenedDropdown;
                    a.checkCloser();
                };
                this.checkCloser = function() {
                    0 < a.numOpenedDropdown
                        ? null === a.closerListener &&
                          (a.closerListener = window.document.addEventListener(
                              "click",
                              function(e) {
                                  if (
                                      (e =
                                      ...
                                      var g = !1;
                                      null ===
                                      e.closest(a.settings.searchBarSelector)
                                          ? (g = !0)
                                          : null !==
                                                e.closest(
                                                    a.settings.closeSelector
                                                ) && (g = !0);
                                      if (
                                          g &&
                                          (e = window.document.querySelectorAll(
                                              "." +
                                                  a.settings
                ...
                this.initGet = function() {
                    ...
                    for (
                        var e = window.document.querySelectorAll(
                                a.settings.searchDropdownTriggerSelector
                            ),
                            g = function(w, y) {
                                var r = e[w],
                                    u = r.closest(a.settings.searchBarSelector);
                                if (u && r) {
                                    var q = u.querySelector(
                                        a.settings.searchDropdownSelector
                                    );
                                    q &&
                        ...
                        g(h, p);
                    var t = window.document.querySelectorAll(
                        a.settings.selector
                    );
                    if (t && t.length)
                        for (
                            g = function(w, y) {
                                ...
                                r.addEventListener("focus", function() {
                                    if (!a.focusBlocked) {
                                        var x = r.closest(
                                            a.settings.searchFormSelector
                                        );
                                        x &&
                                            x.classList.add(
                                                a.settings.focusedSearchForm
                                            );
                                    }
                                });
                                ...
                                if (u) {
                                    ...
                                    v &&
                                        (v.addEventListener("submit", function(
                                            x
                                        ) {
                                            a.recentlyOpenedForm &&
                                                (x.preventDefault(),
                                                a.recentlyOpenedForm.submit());
                                        }),
                                        v.addEventListener("click", function() {
                                            a.focusBlocked || a.forceFocus(r);
                                        }),
                                        (q = v.querySelector(
                                            a.settings.submitIconSelector
                                        )) &&
                                            q.addEventListener(
                                                "click",
                                                function() {
                                    ...
                                    (q = u.querySelector(
                                        a.settings.detailedSelector
                                    )) &&
                                        q.addEventListener("click", function(
                                            x
                                        ) {
                                            var z = u.querySelector(
                                                a.settings
                    ...
                    if (
                        ...
                        for (h = 0, p = g.length; h < p; h++)
                            g[h].addEventListener("click", function(w) {
                                w.preventDefault();
                                a.setState(!1);
                                w.preventDefault();
                                return !1;
                ...
                this.resizeGet = function() {
                    window.document.querySelector(
                        a.settings.xfMenuOpenSelector
                    ) &&
                        a.lastWidth !== window.innerWidth &&
                        ((a.xfMenuOpen = !0),
                        (a.lastWidth = window.innerWidth));
                };
                this.resizeSet = function() {
                    a.xfMenuOpen &&
                        (window.XF.MenuWatcher.closeAll(), (a.xfMenuOpen = !1));
                };
                this.running = !1;
                this.settings = Object.assign(
                    {
                        ...
                        activeTargetsSelector:
                            ".p-nav-inner, .p-sectionLinks, .p-header-content, .p-staffBar",
        ...
        "undefined" === typeof window.themehouse && (window.themehouse = {});
        window.themehouse.minimalSearch = { minimalSearch: l };
        m.a = l;
    },
    function(l, m, n) {
        var k =
            ...
            f = function d(a) {
                for (
                    ...
                    e += "     ";
                if (
                    "object" === ("undefined" === typeof a ? "undefined" : k(a))
                ) {
                    g = Object.keys(a);
                    for (var h = 0, p = g.length; h < p; h++) {
                        var t = g[h],
                            w = a[t];
                        "object" ===
                        ("undefined" === typeof w ? "undefined" : k(w))
                            ? (console.log(e + t + ":"), d(a[t], c + 1))
                            : console.log(e + t + ": " + a[t]);
                    }
        ...
        window.themehouse.debug = function() {
            for (
                var a = window.themehouse.settings,
                    d = Object.keys(a),
                    c = 0,
                    e = d.length;
                c < e;
