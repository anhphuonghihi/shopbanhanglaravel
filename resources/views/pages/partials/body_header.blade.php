                ...
                <div class="p-description">
                    <ul class="listInline listInline--bullet">
                        <li>
                            ...
                            <a href="/members/iso-9002.19/" class="username  u-concealed">
                                {{ $user[0]->username }}</a>
                        </li>
                        <li>
            ...
            <div class="uix_headerInner--opposite">
                ...
                <div class="p-title-pageAction">
                    @if ($post[0]->user_id == Session::get('user_id'))
                        ...
                        <button type="button" class="button--cta button button--icon button--icon--write rippleButton" data-toggle="modal"
                            data-target="#exampleModalCenter">
                            <span
                                class="button-text">Xóa</span>
                        </button>
                            ...
                            ">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="button--cta button button--icon button--icon--write rippleButton">
                                            <a href="/threads/{{ $post[0]->post_slug }}.{{ $post[0]->id }}/delete">Chắc chắn</a>
                                        </button>
                                    </div>
                                </div>
                            </div>
