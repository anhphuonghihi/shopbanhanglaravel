                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            <li><a href="{{ URL::to('/change-password') }}"><i class=" fa fa-suitcase"></i>Đổi mật
                                    khẩu</a>
                            </li>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/manage-payment') }}">Quản lý nạp tiền</a></li>
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{ URL::to('/add-nhan-post') }}">Thêm nhãn</a></li>
                                <li><a href="{{ URL::to('/all-nhan-post') }}">Liệt kê nhãn</a></li>
                                <li><a href="{{ URL::to('/add-select-post') }}">Thêm lựa chọn</a></li>
                                <li><a href="{{ URL::to('/all-select-post') }}">Liệt kê lựa chọn</a></li>
